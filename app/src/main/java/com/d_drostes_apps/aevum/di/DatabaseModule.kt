...
object DatabaseModule {
    ...
    // M18.67: App-Aufzeichnung
    @Provides fun provideAppTrackingEntryDao(database: AppDatabase): AppTrackingEntryDao = database.appTrackingEntryDao()
}