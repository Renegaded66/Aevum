...
import de.devondroste.aevum.automation.geofence.EventDrivenLocationChecker
...
class DriveWatchdogWorker(
    ...
    interface Deps {
        ...
        fun triggerEventRepository(): de.devondroste.aevum.data.repository.TriggerEventRepository
        fun locationChecker(): EventDrivenLocationChecker
    }
    ...
    override suspend fun doWork(): Result {
        ...
        try {
            live.stop()
            triggerRepo.insert(
                de.devondroste.aevum.data.model.TriggerEvent(
